...
class PenjualanKasirController extends Controller
{
    ...
    public function create()
    {
        ...
        return redirect('/kasir/penjualan/'.$penjualans->id_penjualan.'/edit');
    }
    ...
    public function edit(string $id_penjualan)
    {
        ...
        if ($print == 'klik'){
            ...
            $pdf = PDF::loadView('kasir.penjualan.print', $data)->setPaper($customPaper, 'landscape');
            return $pdf->stream();
        }else{
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/kasir/penjualan')->with('Success','Produk has been deteled successfully');
    }
}
