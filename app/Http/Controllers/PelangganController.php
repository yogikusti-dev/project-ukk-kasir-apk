...
class PelangganController extends Controller
{
    ...
    public function show()
    {
        ...
        $pdf = PDF::loadView('admin/pelanggan/cetaklaporan', ['pelanggan'=>$pelanggans])->setPaper('a4', 'potrait');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('pelanggan')->with('Success','Member has been deteled successfully');
