            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @if($users->photo)
                                <img src="{{ asset('storage/photos/'.$users->photo) }}" class="img-thumbnail rounded mx-auto d-block">
                            @else
                        ...
                        <div class="col-md-8">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="username" value="{{ $users->username }}" required autocomplete="username">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="role" type="role" class="form-control @error('email') is-invalid @enderror" name="role" value="{{ old('role', $users->role) }}" required autocomplete="email">
